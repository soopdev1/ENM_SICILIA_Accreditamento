        ...
        <div class="row">
            ...
            <div class="col-md-12 page-404">               
                ...
                <div class="details">
                    ...
                    <%if(err.equals("3")){%>                     
                    Hai già eliminato la domanda di partecipazione.                  
                    <%} else if(err.equals("3A")){ %>    
                    Il bando è scaduto.
                    <%} else if(err.equals("FT")){ %>
                    <i class="fa fa-hourglass-end font-red"></i> Lei ha inviato la domanda oltre i termini previsti dal bando, pertanto la stessa non verrà presa in considerazione.
                    
                    <%} else if(err.equals("2A")){ %>          
                    La domanda non può essere eliminata in quanto in fase di istruttoria.
                    <%}%>
                    </h3>
                    <p class="pull-right">
