    ...
    private static File allegatoB1(String username, String iddocente, DateTime dataconsegna, boolean flatten) {
        try {
            ...
            try (InputStream is = new ByteArrayInputStream(decodeBase64(contentb64)); PdfReader reader = new PdfReader(is); PdfWriter writer = new PdfWriter(pdfOut); PdfDocument pdfDoc = new PdfDocument(reader, writer);) {
                ...
                BarcodeQRCode barcode = new BarcodeQRCode(username + " / ALLEGATO B1 / " + dataconsegna.toString("ddMMyyyyHHmmSSS"));
                printbarcode(barcode, pdfDoc);
...
//                fields.get("finalita").setValue("REALIZZAZIONE DA PARTE DEL S.A. DELLE ATTIVITÀ PREVISTE DALL'AVVISO PUBBLICO VOLTE ALLA FORMAZIONE "
//                        + "E ALL'ACCOMPAGNAMENTO ALL'AUTOIMPIEGO E ALL'AUTOIMPRENDITORIALITÀ DEI GIOVANI NEET SU TUTTO IL TERRITORIO NAZIONALE.");
...
//                fields.get("data").setValue(dataconsegna.toString("dd/MM/yyyy"));
                ...
                BarcodeQRCode barcode = new BarcodeQRCode(username + " / NULLA OSTA / " + dataconsegna.toString("ddMMyyyyHHmmSSS"));
...
////            if (out2 != null) {
////                File out3 = convertPDFA(out2, "Allegato A", Base64.decodeBase64(ActionB.getPath("icc")));
////                if (out3 != null) {
////                    return out3;
////                }
////            }
...
////            File out2 = sign_otp(out1, username);
////            if (out2 != null) {
////                File out3 = convertPDFA(out2, "Allegato B", Base64.decodeBase64(ActionB.getPath("icc")));
////                if (out3 != null) {
////                    return out3;
////                }
////            }
