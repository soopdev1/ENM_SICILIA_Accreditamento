...
import static rc.so.action.ActionB.getConvenzioneROMA;
import static rc.so.action.ActionB.insertConvenzioneROMA;
import static rc.so.action.ActionB.insertDocumentUserConvenzioni;
import static rc.so.action.ActionB.isPresenzaDocumento;
import static rc.so.action.ActionB.listaDocRichiesti;
import static rc.so.action.ActionB.preparefileforupload;
import static rc.so.action.ActionB.trackingAction;
import static rc.so.action.ActionB.verificaPresenzaConvenzioni;
...
import static rc.so.action.Pdf_new.extractSignatureInformation_PDF;
import static rc.so.action.Pdf_new.verificaQR;
import static rc.so.action.Pdf_new.verificaQRNOPDFA;
...
import static rc.so.util.Utility.checkExtension;
import static rc.so.util.Utility.checkFile;
