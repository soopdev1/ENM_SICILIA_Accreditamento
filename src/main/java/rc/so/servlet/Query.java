...
import static rc.so.action.ActionB.countDocumentConvenzioni;
import static rc.so.action.ActionB.getConvenzioneROMA;
import static rc.so.action.ActionB.getDomandeComplete;
import static rc.so.action.ActionB.getInvioEmailROMA;
import static rc.so.action.ActionB.getRagioneSociale;
