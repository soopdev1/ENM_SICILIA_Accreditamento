...
import static rc.so.action.ActionB.newsessionid;
import static rc.so.action.ActionB.trackingAction;
import static rc.so.action.Constant.errLogin;
import static rc.so.action.Constant.homePage;
import static rc.so.action.Constant.homePageAz;
import static rc.so.action.Constant.homePageRup;
import static rc.so.action.Constant.otp;
import static rc.so.action.Constant.reset;
...
import static rc.so.util.Utility.printClientInfo;
