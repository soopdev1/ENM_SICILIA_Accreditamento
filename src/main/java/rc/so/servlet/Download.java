...
import static rc.so.action.ActionB.getAllegatoB1;
import static rc.so.action.ActionB.getConvenzioneROMA;
import static rc.so.action.ActionB.getPath;
import static rc.so.action.ActionB.getPathConvenzioni;
import static rc.so.action.ActionB.listaDocUserBandoDocenti;
import static rc.so.action.ActionB.listaDocUserBando_nofilemcn;
import static rc.so.action.ActionB.listaDocuserbando;
import static rc.so.action.ActionB.preparefilefordownload;
import static rc.so.action.ActionB.trackingAction;
import static rc.so.action.Pdf_new.allegatoA_fase1;
import static rc.so.action.Pdf_new.allegatoB1;
import static rc.so.action.Pdf_new.allegatoB_fase1;
import static rc.so.action.Pdf_new.allegatoC;
import static rc.so.action.Pdf_new.allegatoC_mod1;
import static rc.so.action.Pdf_new.allegatoC_mod2;
